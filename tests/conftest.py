...
from hui.db.dependencies import get_db_session
from hui.db.utils import create_database, drop_database
from hui.services.kafka.dependencies import get_kafka_producer
from hui.services.kafka.lifespan import init_kafka, shutdown_kafka
from hui.services.rabbit.dependencies import get_rmq_channel_pool
from hui.services.rabbit.lifespan import init_rabbit, shutdown_rabbit
from hui.services.redis.dependency import get_redis_pool
from hui.settings import settings
from hui.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from hui.db.models import load_all_models
